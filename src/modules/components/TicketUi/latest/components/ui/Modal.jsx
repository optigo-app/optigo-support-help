...
/**
 * @typedef {'suggest' | 'close' | 'reopen'} ConfirmModalType
 */
...
const ReusableConfirmModal = ({ open, onClose, onConfirm, type }) => {
	const modalConfigs = {
		...
		reopen: {
			...
			icon: <RestorePageRounded color="error" />,
			message: "Contact Optigo Team for reopening this ticket within 10 days of closure. After that, it will be archived and no longer editable. ",
