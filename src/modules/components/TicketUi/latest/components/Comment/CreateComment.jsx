...
const CreateComment = ({isCommenting ,attachmentsList , user, data, setOpen, Message, setMessage, OfficeUse, setOfficeUse, handleAttachmentChange, fileName, attachment, HandleCommentEdit, PreviewImage, setOpenPreview }) => {
	return (
		<Box sx={{ p: 2 }}>
			{/* To Field */}
    ...
    <AttachMentGroup size={26} attachmentsList={attachmentsList} setOpenPreview={setOpenPreview} />
