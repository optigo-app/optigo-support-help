...
export default function HelpCenter() {
  ...
  const startListening = () => {
    ...
    if (!SpeechRecognition) {
      alert(
        lang === "hi"
          ? "इस ब्राउज़र में स्पीच रिकग्निशन समर्थित नहीं है। कृपया क्रोम या एज का उपयोग करें।"
    ...
    rec.onerror = (event) => {
      ...
      setVoiceText(
        lang === "hi"
          ? "त्रुटि! कृपया फिर से प्रयास करें।"
  ...
  const filteredMenuData = React.useMemo(() => {
    ...
    return roleData.menuData
      .map((section) => ({
        ...section,
        items: section.items.filter((item) => {
          const titleMatch =
            item.title.toLowerCase().includes(query) ||
            (item.titleHindi && item.titleHindi.toLowerCase().includes(query));
          const descMatch =
            (item.desc && item.desc.toLowerCase().includes(query)) ||
            (item.descHindi && item.descHindi.toLowerCase().includes(query));
          const sectionMatch =
            section.section.toLowerCase().includes(query) ||
            (section.sectionHindi &&
              section.sectionHindi.toLowerCase().includes(query));
  ...
  const activeItem = React.useMemo(() => {
    ...
    return (
      allItems.find((item) => item.slug === activeVideoSlug) || allItems[0]
    );
    ...
    if (roleData) {
      if (activeVideoSlug && activeItem) {
        const displayVideoTitle =
          lang === "hi" && activeItem.titleHindi
            ? activeItem.titleHindi
            : activeItem.title;
  ...
  const metaDescription = React.useMemo(() => {
    let description =
      "Access Optigo ERP training videos, FAQs, and live support to master the platform.";
    if (roleData) {
      if (activeVideoSlug && activeItem) {
        const displayVideoTitle =
          lang === "hi" && activeItem.titleHindi
  ...
  if (!tab) {
    return (
      <ThemeWrapper>
        <MetaWrapper
          page="Help"
          title="Video Help | Optigo Support"
          description="Choose between training videos and quick help videos."
        />
        <Box
          sx={{
            bgcolor: "#F9FAFB",
        ...
        >
          <Box sx={{ textAlign: "center", mb: 6 }}>
            <Typography
              variant="h6"
              sx={{ color: "#4B5563", maxWidth: 550, mx: "auto", px: 2 }}
            >
              Select a path below to get started with step-by-step training or
          ...
          >
            ...
            <Box
              ...
              sx={{
                ...
                background:
                  "linear-gradient(135deg, rgba(124, 77, 255, 0.12) 0%, rgba(124, 77, 255, 0.03) 100%)",
                ...
                "&:hover": {
                  flex: { xs: 1, sm: 1.25 },
                  background:
                    "linear-gradient(135deg, rgba(124, 77, 255, 0.2) 0%, rgba(124, 77, 255, 0.08) 100%)",
            ...
            >
              ...
              <Box>
                ...
                <Typography
                  sx={{
                    color: "rgba(26, 14, 66, 0.75)",
                    fontSize: "13px",
                    lineHeight: 1.4,
                    fontWeight: 500,
                  }}
                >
                  Master the platform with step-by-step tutorials and
                  interactive guides.
                </Typography>
              </Box>
            </Box>
            ...
            >
              ...
              <Box>
                ...
                <Typography
                  sx={{
                    color: "rgba(0, 72, 84, 0.75)",
                    fontSize: "13px",
                    lineHeight: 1.4,
                    fontWeight: 500,
                  }}
                >
                  Quick visual answers to frequently asked questions and
                  troubleshooting.
                </Typography>
              </Box>
            </Box>
  ...
  if (tab !== "help-videos" && !role) {
    return (
      <ThemeWrapper>
        <MetaWrapper
          page="Help"
          title="Training Center | Optigo Support"
          description="Access Optigo ERP training videos and guides."
        />
        <SelectTrainingPath />
      </ThemeWrapper>
    );
  ...
  return (
    <ThemeWrapper>
      <MetaWrapper
        page="Help"
        title={
          tab === "help-videos" ? "Help Videos | Optigo Support" : metaTitle
        }
        description={
          tab === "help-videos"
            ? "Browse quick help videos and solutions for Optigo ERP."
            : metaDescription
        }
      />
              ...
              {tab === "help-videos" ? (
                <>
                  ...
                  >
                    ...
                    >
                      <PlayCircleOutlineIcon sx={{ color: "#8B5CF6" }} /> Help
                      Categories
                    </Typography>
                  </Box>
                ...
                <>
                  ...
                  >
                    ...
                    >
                      {roleData ? (
                        <>
                          {roleData.icon} {roleData.label} Training
                        </>
                      ) : (
                        "Learning Center"
                      )}
                  ...
                  >
                    {roleData?.menuData.map((section) => {
                      ...
                      const displaySectionName = section.section;
                      return (
                ...
                <Box sx={{ maxWidth: 600, flexGrow: 1 }}>
                  <TextField
                    ...
                    placeholder={
                      tab === "help-videos"
                        ? "Search help videos..."
                        : "Search for tutorials, help files and frequently asked questions"
                    }
                    variant="outlined"
                    size="small"
                    InputProps={{
              ...
              {tab === "help-videos" ? (
                  ...
                  {filteredHelpVideos.length === 0 ? (
                    ...
                    >
                      <PlayCircleOutlineIcon
                        sx={{ fontSize: 70, color: "#D1D5DB", mb: 2 }}
                      />
                      <Typography
                        variant="h6"
                ...
                <>
                  ...
                  >
                    <Box>
                      <Typography variant="h4" gutterBottom>
                        {activeItem?.title || roleData?.label || "Training"}
                      </Typography>
                      <Typography variant="body2">
                        {activeItem?.desc ||
                          `Explore ${roleData?.label} training resources.`}
                      </Typography>
                    </Box>
                  </Box>
                  ...
                  {filteredMenuData.length === 0 ? (
                    ...
                    >
                      <PlayCircleOutlineIcon
                        sx={{ fontSize: 80, color: "#E5E7EB", mb: 2 }}
                      />
                      <Typography
                        variant="h6"
                        sx={{ color: "#4B5563", fontWeight: 700 }}
                      ...
                      <Typography
                        variant="body2"
                        sx={{ color: "#6B7280", mt: 1, maxWidth: 300 }}
                      >
                              ...
                              return (
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <Box
                                      component="img"
                                      src={`https://img.youtube.com/vi/${lang === "hi" && item.youtubeIdHindi ? item.youtubeIdHindi : item.youtubeIdEnglish || item.youtubeId}/mqdefault.jpg`}
                                      alt={item.title}
                                      sx={{
                                        position: "absolute",
                                        top: 0,
        ...
        >
          ...
          <Box
            sx={{
              ...
              borderRadius: 3,
              transformOrigin: "center",
              animation: "sound-wave 0.8s ease-in-out infinite 0.15s",
            }}
          />
          <Box
            sx={{
              ...
              borderRadius: 3,
              transformOrigin: "center",
              animation: "sound-wave 1.1s ease-in-out infinite 0.3s",
            }}
          />
          <Box
            sx={{
              ...
              borderRadius: 3,
              transformOrigin: "center",
              animation: "sound-wave 0.7s ease-in-out infinite 0.05s",
            }}
          />
        </Box>
